 ...
 * CLASSPATH=.:../build javac Sftp.java $ CLASSPATH=.:../build java Sftp You
 * will be asked username, host and passwd. If everything works fine, you will
 * get a prompt 'sftp>'. 'help' command will show available command. In current
 * implementation, the destination path for 'get' and 'put' commands must be a
